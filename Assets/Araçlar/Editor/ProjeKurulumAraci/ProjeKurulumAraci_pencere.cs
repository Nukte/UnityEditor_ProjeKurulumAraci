...
namespace Araclar
{
    public class ProjeKurulumAraci_pencere : EditorWindow
    {
        ...
        // Oyun türü seçimi
        private int selectedGameTypeIndex = 0;  // Deðiþkeni int olarak tanýmladýk
        ...
        void CreateProjectFolders()
        {
            ...
            AssetDatabase.Refresh(); // Unity'yi klasör deðiþikliklerinden haberdar et
        ...
        void CreateSpecificFolders(string rootPath)
        {
            ...
            // Seçilen oyun türüne göre klasörler oluþturulacak
            if (createArtFolder)
            {
        ...
        {
            Scene curScene = EditorSceneManager.NewScene(NewSceneSetup.DefaultGameObjects, NewSceneMode.Single); // Doðru metod burada kullanýldý
